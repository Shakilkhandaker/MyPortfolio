    ...
    const data = [
        {
            ...
            description: 'Java, Spring Boot, JPA, REST APIs, MVC architecture',
        },
        {
            name: 'Database',
            icon1: './assets/edu-icon.png',
            icon2: './assets/edu-icon-dark.png',
            description: 'MySQL • PostgreSQL • MongoDB • Query optimization (joins, grouping)',
        },
        {
            name: 'Achievements',
            icon1: './assets/project-icon.png',
            icon2: './assets/project-icon-dark.png',
            description: 'Champion (SAD showcase) — Krishok Bondhu • 2nd Runner-up (SE showcase) — Shohoj Thikana',
        },
    ];
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                <div className="max-w-max mx-auto relative">
                    <img src='./assets/user-image.png' alt="Shakil" className="w-64 sm:w-80 rounded-3xl max-w-none" />
                ...
                <div className="flex-1">
                    <p className="mb-10 max-w-2xl font-Ovo">
                        I&apos;m a backend-focused developer who enjoys turning real problems into reliable products.
                        I work mainly with Java and Spring Boot to build clean, maintainable REST APIs, and I&apos;m comfortable with SQL databases.
                        I&apos;ve also built Android apps with Native Java and Firebase, and I enjoy collaborating in a team environment.
                    </p>
